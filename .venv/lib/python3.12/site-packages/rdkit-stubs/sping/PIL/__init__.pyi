...
f: _io.BufferedReader  # value = <_io.BufferedReader name='/project/build/temp.linux-x86_64-cpython-312/rdkit_install/lib/python3.12/site-packages/rdkit/sping/PIL/pilfonts/metrics.dat'>
figureArc: int = 2
figureCurve: int = 3
figureLine: int = 1
