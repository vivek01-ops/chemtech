...
def JSONToMols(jsonBlock: str, params: typing.Any = None) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple JSONToMols(std::string [,boost::python::api::object=None])
    """
def MolToJSON(mol: Mol, params: typing.Any = None) -> str:
    """
        ...
        C++ signature :
            std::string MolToJSON(RDKit::ROMol [,boost::python::api::object=None])
    """
def MolsToJSON(mols: typing.Any, params: typing.Any = None) -> str:
    """
        ...
        C++ signature :
            std::string MolsToJSON(boost::python::api::object [,boost::python::api::object=None])
    """
