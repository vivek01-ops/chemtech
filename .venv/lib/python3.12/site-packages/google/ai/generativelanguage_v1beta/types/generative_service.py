...
class Candidate(proto.Message):
    ...
    Attributes:
        ...
        content (google.ai.generativelanguage_v1beta.types.Content):
            ...
            the model.
        finish_message (google.ai.generativelanguage_v1beta.types.Candidate.FinishReason):
    ...
    finish_message: FinishReason = proto.Field(
        proto.ENUM,
        number=2,
        enum=FinishReason,
    )
