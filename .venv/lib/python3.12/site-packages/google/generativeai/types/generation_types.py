    ...
    def text(self):
        ...
        if not parts:
            ...
            msg = (
                ...
                f"[finish_message](https://ai.google.dev/api/generate-content#finishreason) is {fr}."
            )
            if candidate.finish_message:
                msg += 'The `finish_message` is "{candidate.finish_message}".'

            if fr is FinishReason.finish_message_UNSPECIFIED:
                raise ValueError(msg)
